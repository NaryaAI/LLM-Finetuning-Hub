...
@click.command()
@click.option("--huggingface_token", prompt=True, help="Your Hugging Face token")
...
@click.option("--server", default="ray", prompt=True, help="Compute type (tgi, ray, triton, vllm): ")
